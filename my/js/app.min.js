...
*/
    r.r(e);
    var s, a, o, u, h, l, f, c, p, _, d, m, g, v, y, x, b, T, w, O, M, k, C, A, D, S, P, z = {
        autoSleep: 120,
        force3D: "auto",
        nullTargetWarn: 1,
        units: {
        ...
        overwrite: !1,
        delay: 0
    }, R = 1e8, E = 2 * Math.PI, B = E / 4, L = 0, I = Math.sqrt, Y = Math.cos, N = Math.sin, X = function(t) {
    ...
    , Z = Array.isArray, $ = /(?:-?\.?\d|\.)+/gi, J = /[-+=.]*\d+[.e\-+]*\d*[e\-\+]*\d*/g, K = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, tt = /[-+=.]*\d+(?:\.|e-|e)*\d*/gi, et = /[+-]=-?[\.\d]+/, rt = /[#\-+.]*\b[a-z\d-=+%.]+/gi, it = {}, nt = {}, st = function(t) {
        ...
        return (r = t[e]) && U(r) ? t[e]() : j(r) && t.getAttribute && t.getAttribute(e) || r
    }, bt = function(t, e) {
        ...
        var i, n = q(t[1]), s = (n ? 2 : 1) + (e < 2 ? 0 : 1), a = t[s];
        if (n && (a.duration = t[1]),
        a.parent = r,
        e) {
            for (i = a; r && !("immediateRender"in i); )
                i = r.vars.defaults || {},
                r = G(r.vars.inherit) && r.parent;
        ...
        var r = t._dp;
        return r && r.smoothChildTiming && t._ts && (t._start = Tt(t._dp._time - (t._ts > 0 ? e / t._ts : ((t._dirty ? t.totalDuration() : t._tDur) - e) / -t._ts)),
        Ut(t),
        r._dirty || Lt(r, t)),
        t
    }, jt = function(t, e) {
        var r;
        if ((e._time || e._initted && !e._dur) && (r = Xt(t.rawTime(), e),
        (!e._dur || Kt(0, e.totalDuration(), r) - e._tTime > 1e-8) && e.render(r, !0)),
        ...
        return Ve(t, e),
        t._initted ? !r && t._pt && (t._dur && !1 !== t.vars.lazy || !t._dur && t.vars.lazy) && l !== Me.frame ? (ft.push(t),
        t._lazy = [e, i],
        1) : void 0 : 1
    }, Qt = function(t, e, r, i) {
        var n = t._repeat
        ...
        t._dur = s,
        t._tDur = n ? n < 0 ? 1e10 : Tt(s * (n + 1) + t._rDelay * n) : s,
        a && !i ? qt(t, t._tTime = t._tDur * a) : t.parent && Ut(t),
        r || Lt(t.parent, t),
        t
    }, Ht = function(t) {
        return t instanceof Ne ? Lt(t) : Qt(t, t._dur)
    }, Zt = {
        _start: 0,
        endTime: ht
    }, $t = function t(e, r) {
        var i, n, s = e.labels, a = e._recent || Zt, o = e.duration() >= R ? a.endTime(!1) : e._dur;
        return X(r) && (isNaN(r) || r in s) ? "<" === (i = r.charAt(0)) || ">" === i ? ("<" === i ? a._start : a.endTime(a._repeat >= 0)) + (parseFloat(r.substr(1)) || 0) : (i = r.indexOf("=")) < 0 ? (r in s || (s[r] = o),
        ...
        t.forEach((function(t) {
            var i;
            return X(t) && !e || re(t, 1) ? (i = r).push.apply(i, ne(t)) : r.push(t)
        }
        )) || r
    }, ne = function(t, e) {
        return !X(t) || e || !o && ke() ? Z(t) ? ie(t, e) : re(t) ? ee.call(t, 0) : t ? [t] : [] : ee.call(u.querySelectorAll(t), 0)
    }, se = function(t) {
        ...
        l = i[1]),
        function(t, a, f) {
            var c, p, _, d, m, g, v, y, x, b = (f || e).length, T = s[b];
            if (!T) {
                if (!(x = "auto" === e.grid ? 0 : (e.grid || [1, R])[1])) {
                    for (v = -R; v < (v = f[x++].getBoundingClientRect().left) && x < b; )
                        ;
                    x--
                }
                for (T = s[b] = [],
                c = o ? Math.min(x, b) * h - .5 : i % x,
                p = o ? b * l / x - .5 : i / x | 0,
                v = 0,
                y = R,
                g = 0; g < b; g++)
                    _ = g % x - c,
                    d = p - (g / x | 0),
                    T[g] = m = u ? Math.abs("y" === u ? d : _) : I(_ * _ + d * d),
                    m > v && (v = m),
                    m < y && (y = m);
                "random" === i && se(T),
                T.max = v - y,
                T.min = y,
                T.v = b = (parseFloat(e.amount) || parseFloat(e.each) * (x > b ? b - 1 : u ? "y" === u ? b / x : x : Math.max(x, b / x)) || 0) * ("edges" === i ? -1 : 1),
                T.b = b < 0 ? n - b : n,
                T.u = te(e.amount || e.each) || 0,
                r = r && b < 0 ? Pe(r) : r
            }
            return b = (T[t] - T.min) / T.max || 0,
            Tt(T.b + (r ? r(b) : b) * T.v) + T.u
        }
    }, oe = function(t) {
        var e = t < 1 ? Math.pow(10, (t + "").length - 2) : 1;
        return function(r) {
            return Math.floor(Math.round(parseFloat(r) / t) * t * e) / e + (q(r) ? 0 : te(r))
        }
    }, ue = function(t, e) {
        var r, i, n = Z(t);
        return !n && V(t) && (r = n = t.radius || R,
        t.values ? (t = ne(t.values),
        (i = !q(t[0])) && (r *= r)) : t = oe(t.increment)),
        Jt(e, n ? U(t) ? function(e) {
            return i = t(e),
            Math.abs(i - e) <= r ? i : e
        }
        : function(e) {
            for (var n, s, a = parseFloat(i ? e.x : e), o = parseFloat(i ? e.y : 0), u = R, h = 0, l = t.length; l--; )
        ...
        return Jt(Z(t) ? !e : !0 === r ? !!(r = 0) : !i, (function() {
            return Z(t) ? t[~~(Math.random() * t.length)] : (r = r || 1e-5) && (i = r < 1 ? Math.pow(10, (r + "").length - 2) : 1) && Math.floor(Math.round((t + Math.random() * (e - t)) / r) * r * i) / i
        }
        ))
    }, le = function(t, e, r) {
        ...
        for (var e, r, i, n, s = 0, a = ""; ~(e = t.indexOf("random(", s)); )
            i = t.indexOf(")", e),
            n = "[" === t.charAt(e + 7),
            r = t.substr(e + 7, i - e - 7).match(n ? rt : $),
        ...
        var i, n, s, a, o, u, h, l, f, c, p = t ? q(t) ? [t >> 16, t >> 8 & 255, 255 & t] : 0 : ge.black;
        if (!p) {
            ...
            ge[t])
                ...
                p = t.match($) || ge.transparent;
            p = p.map(Number)
        }
        return e && !c && (i = p[0] / 255,
        n = p[1] / 255,
        s = p[2] / 255,
        ...
        (i = r.c).join(o) !== s.c.join(o)))
            for (a = (n = t.replace(Te, "1").split(K)).length - 1; l < a; l++)
    ...
    M = O = 1e3 / 240,
    C = function t(e) {
        var r, i, n, s, a = y() - w, o = !0 === e;
        if (a > x && (T += a - b),
        ((r = (n = (w += a) - T) - M) > 0 || o) && (s = ++m.frame,
        g = n - 1e3 * m.time,
        m.time = n /= 1e3,
        M += r + (r >= O ? 4 : O - r),
        i = 1),
    ...
    m = {
        ...
        wake: function() {
            ...
            u = a.document || {},
            it.gsap = pr,
            (a.gsapVersions || (a.gsapVersions = [])).push(pr.version),
            st(nt || a.GreenSockGlobals || !a.gsap && a || {}),
        ...
        sleep: function() {
            (d ? a.cancelAnimationFrame : clearTimeout)(p),
            c = 0,
            _ = ht
        },
        ...
        return !c && Me.wake()
    }, Ce = {}, Ae = /^[\d.\-M][\d.\-,\s]/, De = /["']/g, Se = function(t) {
        ...
        return t && (U(t) ? t : Ce[t] || function(t) {
            var e, r, i, n, s = (t + "").split("("), a = Ce[s[0]];
            return a && s.length > 1 && a.config ? a.config.apply(null, ~t.indexOf("{") ? [Se(s[1])] : (e = t,
            r = e.indexOf("(") + 1,
            i = e.indexOf(")"),
            n = e.indexOf("(", r),
            e.substring(r, ~n && n < i ? e.indexOf(")", i + 1) : i)).split(",").map(Ct)) : Ce._CE && Ae.test(t) ? Ce._CE("", t) : a
        }(t)) || e
    }, Re = function(t, e, r, i) {
    ...
    Ce.SteppedEase = Ce.steps = it.SteppedEase = {
        config: function(t, e) {
            void 0 === t && (t = 1);
            var r = 1 / t
              , i = t + (e ? 0 : 1)
    ...
    var Ie = function(t, e) {
      ...
      , Ye = function() {
        ...
        e.timeScale = function(t) {
            ...
            It(this.totalTime(Kt(-this._delay, this._tDur, e), !0))
        }
        ,
        e.paused = function(t) {
            return arguments.length ? (this._ps !== t && (this._ps = t,
            t ? (this._pTime = this._tTime || Math.max(-this._delay, this.rawTime()),
            this._ts = this._act = 0) : (ke(),
            this._ts = this._rts,
    ...
    var Ne = function(t) {
        function e(e, r) {
            ...
            n.parent && jt(n.parent, i(n)),
            e.scrollTrigger && Gt(i(n), e.scrollTrigger),
            n
        }
        n(e, t);
        var r = e.prototype;
        return r.to = function(t, e, r) {
            return new He(t,Ot(arguments, 0, this),$t(this, q(e) ? arguments[3] : r)),
            this
        }
        ,
        r.from = function(t, e, r) {
            return new He(t,Ot(arguments, 1, this),$t(this, q(e) ? arguments[3] : r)),
            this
        }
        ,
        r.fromTo = function(t, e, r, i) {
            return new He(t,Ot(arguments, 2, this),$t(this, q(e) ? arguments[4] : i)),
            this
        }
        ,
        r.set = function(t, e, r) {
            ...
            new He(t,e,$t(this, r),1),
            this
        }
        ,
        r.call = function(t, e, r) {
            return Vt(this, He.delayedCall(0, t, e), $t(this, r))
        }
        ,
        ...
        r.staggerFromTo = function(t, e, r, i, n, s, a, o) {
            return i.startAt = r,
            Rt(i).immediateRender = G(i.immediateRender),
            this.staggerTo(t, e, i, n, s, a, o)
        }
        ,
        r.render = function(t, e, r) {
            var i, n, a, o, u, h, l, f, c, p, _, d, m = this._time, g = this._dirty ? this.totalDuration() : this._tDur, v = this._dur, y = this !== s && t > g - 1e-8 && t >= 0 ? g : t < 1e-8 ? 0 : t, x = this._zTime < 0 != t < 0 && (this._initted || !v);
            if (y !== this._tTime || r || x) {
                ...
                o !== p && !this._lock)) {
                    ...
                    m = b ? 0 : v,
                    this._lock = 1,
                    this.render(m || (d ? 0 : Tt(o * u)), e, !v)._lock = 0,
                ...
                i >= m && t >= 0)
                    ...
                    for (var w = t < 0 ? t : i; n; ) {
                        if (a = n._prev,
                        (n._act || w <= n._end) && n._ts && l !== n) {
                            if (n.parent !== this)
                                return this.render(t, e, r);
                            if (n.render(n._ts > 0 ? (w - n._start) * n._ts : (n._dirty ? n.totalDuration() : n._tDur) + (w - n._start) * n._ts, e, r),
                            i !== this._time || !this._ts && !h) {
                                l = 0,
                                a && (y += this._zTime = w ? -1e-8 : 1e-8);
                                break
                            }
                        }
                        n = a
                ...
                (y === g && g >= this.totalDuration() || !y && m) && (c !== this._start && Math.abs(f) === Math.abs(this._ts) || this._lock || ((t || !v) && (y === g && this._ts > 0 || !y && this._ts < 0) && Bt(this, 1),
                e || t < 0 && !m || !y && !m || (_e(this, y === g ? "onComplete" : "onReverseComplete", !0),
        ...
        ,
        r.remove = function(t) {
            return X(t) ? this.removeLabel(t) : U(t) ? this.killTweensOf(t) : (Et(this, t),
        ...
        r.totalTime = function(e, r) {
            ...
            !this._dp && this._ts && (this._start = Tt(Me.time - (this._ts > 0 ? e / this._ts : (this.totalDuration() - e) / -this._ts))),
        ...
        r.getTweensOf = function(t, e) {
            for (var r, i = [], n = ne(t), s = this._first, a = q(e); s; )
                s instanceof He ? wt(s._targets, n) && (a ? (!Xe || s._initted && s._ts) && s.globalTime(0) <= e && s.globalTime(s.totalDuration()) > e : !e || s.isActive()) && i.push(s) : (r = s.getTweensOf(n, e)).length && i.push.apply(i, r),
                s = s._next;
            return i
        }
        ,
        ...
        r.totalDuration = function(t) {
            var e, r, i, n = 0, a = this, o = a._last, u = R;
            if (arguments.length)
            ...
            if (a._dirty) {
                for (i = a.parent; o; )
                    ...
                    Vt(a, o, r - o._delay, 1)._lock = 0) : u = r,
                    r < 0 && o._ts && (n -= r,
                    ...
                    o = e;
                Qt(a, a === s && a._time > n ? a._time : n, 1, 1),
                a._dirty = 0
            }
            return a._tDur
        }
        ...
        e.updateRoot = function(t) {
            if (s._ts && (kt(s, Xt(t, s)),
            l = Me.frame),
            Me.frame >= dt) {
                dt += z.autoSleep || 120;
                var e = s._first;
                if ((!e || !e._ts) && z.autoSleep && Me._listeners.length < 2) {
                    for (; e && !e._ts; )
                        e = e._next;
                    e || Me.sleep()
                }
    ...
    var Xe, Ue = function(t, e, r, i, n, s, a) {
        var o, u, h, l, f, c, p, _, d = new hr(this._pt,t,e,0,1,ir,null,n), m = 0, g = 0;
        for (d.b = r,
        d.e = i,
        r += "",
        ...
        U(i) && (i = i(n || 0, t, s));
        var h, l = t[e], f = "get" !== r ? r : U(l) ? u ? t[e.indexOf("set") || !U(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)](u) : t[e]() : l, c = U(l) ? u ? Je : $e : Ze;
        if (X(i) && (~i.indexOf("random(") && (i = fe(i)),
        "=" === i.charAt(1) && (i = parseFloat(f) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (te(f) || 0))),
        f !== i)
            return isNaN(f * i) ? (!l && !(e in t) && at(e, i),
            Ue.call(this, t, e, f, i, c, o || z.stringFilter, u)) : (h = new hr(this._pt,t,e,+f || 0,i - (f || 0),"boolean" == typeof l ? rr : er,0,c),
            u && (h.fp = u),
        ...
        if (pt[t] && !1 !== (a = new pt[t]).init(n, a.rawVars ? e[t] : function(t, e, r, i, n) {
            if (U(t) && (t = Ge(t, n, e, r, i)),
            !V(t) || t.style && t.nodeType || Z(t) || H(t))
                return X(t) ? Ge(t, n, e, r, i) : t;
            var s, a = {};
            for (s in t)
                a[s] = Ge(t[s], n, e, r, i);
            return a
        }(e[t], i, n, s, r), r, i, s) && (r._pt = o = new hr(r._pt,n,t,0,1,a.render,a,0,a.priority),
        r !== f))
        ...
        !B) {
            ...
            b = D && G(b) || b && !D,
            n = 0; n < P.length; n++) {
                if (l = (u = P[n])._gsap || vt(P)[n]._gsap,
                e._ptLookup[n] = p = {},
                ct[l.id] && ft.length && Mt(),
                _ = R === P ? n : R.indexOf(u),
                f && !1 !== (c = new f).init(u, d || i, e, _, R) && (e._pt = o = new hr(e._pt,u,c.name,0,1,c.render,c,0,c.priority),
                ...
                !f || d)
                    for (a in i)
                        pt[a] && (c = je(a, i, e, _, u, R)) ? c.priority && (h = 1) : p[a] = o = qe.call(e, u, a, "get", i[a], _, R, 0, g.stringFilter);
        ...
        return U(t) ? t.call(e, r, i, n) : X(t) && ~t.indexOf("random(") ? fe(t) : t
    }, We = gt + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", Qe = (We + ",id,stagger,delay,duration,paused,scrollTrigger").split(","), He = function(t) {
        function e(e, r, n, a) {
            var o;
            "number" == typeof r && (n.duration = r,
            r = n,
            n = null);
            var u, h, l, f, c, p, _, d, m = (o = t.call(this, a ? r : Rt(r), n) || this).vars, g = m.duration, v = m.delay, y = m.immediateRender, x = m.stagger, b = m.overwrite, T = m.keyframes, w = m.defaults, O = m.scrollTrigger, M = m.yoyoEase, k = o.parent, C = (Z(e) || H(e) ? q(e[0]) : "length"in r) ? [e] : ne(e);
            if (o._targets = C.length ? vt(C) : ot("GSAP target " + e + " not found. https://greensock.com", !z.nullTargetWarn) || [],
            o._ptLookup = [],
            o._overwrite = b,
            T || x || Q(g) || Q(v)) {
                if (r = o.vars,
                ...
                T)
                    ...
                    for (h = 0; h < f; h++) {
                        for (c in l = {},
                        r)
                            Qe.indexOf(c) < 0 && (l[c] = r[c]);
                        l.stagger = 0,
                        M && (l.yoyoEase = M),
                        d && Pt(l, d),
                        p = C[h],
                        l.duration = +Ge(g, i(o), h, p, C),
                        l.delay = (+Ge(v, i(o), h, p, C) || 0) - o._delay,
                        !x && 1 === f && l.delay && (o._delay = v = l.delay,
                        o._start += v,
                        l.delay = 0),
                        u.to(p, l, _(h, p, C))
                    }
            ...
            Xe = 0),
            k && jt(k, i(o)),
            (y || !g && !T && o._start === Tt(k._time) && G(y) && function t(e) {
                return !e || e._ts && t(e.parent)
            }(i(o)) && "nested" !== k.data) && (o._tTime = -1e-8,
        ...
        return r.render = function(t, e, r) {
            var i, n, s, a, o, u, h, l, f, c = this._time, p = this._tDur, _ = this._dur, d = t > p - 1e-8 && t >= 0 ? p : t < 1e-8 ? 0 : t;
            if (_) {
                if (d !== this._tTime || !t || r || this._startAt && this._zTime < 0 != t < 0) {
                    ...
                    this._repeat) {
                        ...
                        i === c && !r && this._initted)
                            return this;
                        s !== o && (l && this._yEase && ze(l, u),
                        !this.vars.repeatRefresh || u || this._lock || (this._lock = r = 1,
                        this.render(Tt(a * s), !0).invalidate()._lock = 0))
                    }
                    if (!this._initted) {
                        if (Wt(this, t < 0 ? t : i, r, e))
                    ...
                    _e(this, "onUpdate")),
                    this._repeat && s !== o && this.vars.onRepeat && !e && this.parent && _e(this, "onRepeat"),
                    d !== this._tDur && d || this._tTime !== d || (t < 0 && this._startAt && !this._onUpdate && this._startAt.render(t, !0, !0),
                    (t || !_) && (d === this._tDur && this._ts > 0 || !d && this._ts < 0) && Bt(this, 1),
                    e || t < 0 && !c || !d && !c || (_e(this, d === p ? "onComplete" : "onReverseComplete", !0),
                    this._prom && !(d < p && this.timeScale() > 0) && this._prom()))
                }
            } else
                !function(t, e, r, i) {
                    var n, s, a = t.ratio, o = e < 0 || !e && a && !t._start && t._zTime > 1e-8 && !t._dp._lock || (t._ts < 0 || t._dp._ts < 0) && "isFromStart" !== t.data && "isStart" !== t.data ? 0 : 1, u = t._rDelay, h = 0;
                    if (u && t._repeat && (h = Kt(0, t._tDur, e),
                    Nt(h, u) !== (s = Nt(t._tTime, u)) && (a = 1 - o,
                    ...
                    o !== a || i || 1e-8 === t._zTime || !e && t._zTime) {
                        ...
                        (e >= t._tDur || e < 0) && t.ratio === o && (o && Bt(t, 1),
                        r || (_e(t, o ? "onComplete" : "onReverseComplete", !0),
                        t._prom && t._prom()))
                    } else
                        t._zTime || (t._zTime = e)
                }(this, t, e, r);
        ...
        r.kill = function(t, e) {
            ...
            if (this.timeline) {
                ...
                return this.timeline.killTweensOf(t, e, Xe && !0 !== Xe.vars.overwrite)._first || de(this),
                this.parent && r !== this.timeline.totalDuration() && Qt(this, this._dur * this.timeline._tDur / r, 0, 1),
                this
            }
            var i, n, s, a, o, u, h, l = this._targets, f = t ? ne(t) : l, c = this._ptLookup, p = this._pt;
    ...
    var Ze = function(t, e, r) {
      ...
      , tr = function(t, e) {
        return U(t[e]) ? $e : j(t[e]) && t.setAttribute ? Ke : Ze
    }
      , er = function(t, e) {
    ...
    var lr = {
        ...
        defaults: function(t) {
            return t && t.ease && (t.ease = Fe(t.ease, F.ease)),
            zt(F, t || {})
        },
        config: function(t) {
            return zt(z, t || {})
        ...
        exportRoot: function(t, e) {
            ...
            r = s._first; r; )
                i = r._next,
                !e && !r._dur && r instanceof He && r.vars.onComplete === r._targets[0] || Vt(n, r, r._start - r._delay),
                r = i;
            return Vt(s, n, 0),
            n
        },
        utils: {
            wrap: function t(e, r, i) {
                var n = r - e;
                return Z(e) ? le(e, t(0, e.length), r) : Jt(i, (function(t) {
                    return (n + (t - e) % n) % n + e
                }
                ))
            },
            wrapYoyo: function t(e, r, i) {
                var n = r - e
                  , s = 2 * n;
                return Z(e) ? le(e, t(0, e.length - 1), r) : Jt(i, (function(t) {
    ...
    }, cr("roundProps", oe), cr("modifiers"), cr("snap", ue)) || lr;
    He.version = Ne.version = pr.version = "3.5.1",
    h = 1,
    W() && ke();
    Ce.Power0,
    Ce.Power1,
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
    var _r, dr, mr, gr, vr, yr, xr, br, Tr = {}, wr = 180 / Math.PI, Or = Math.PI / 180, Mr = Math.atan2, kr = /([A-Z])/g, Cr = /(?:left|right|width|margin|padding|x)/i, Ar = /[\s,\(]\S/, Dr = {
        ...
        s[e] = r,
        s.renderTransform(n, s)
    }, Ur = "transform", qr = Ur + "Origin", jr = function(t, e) {
        ...
        return n[r] || n.getPropertyValue(r.replace(kr, "-$1").toLowerCase()) || n.getPropertyValue(r) || !i && t(e, Wr(r) || r, 1) || ""
    }, Gr = "O,Moz,ms,Ms,Webkit".split(","), Wr = function(t, e, r) {
        var i = (e || vr).style
          , n = 5;
        if (t in i && !r)
            return t;
        for (t = t.charAt(0).toUpperCase() + t.substr(1); n-- && !(Gr[n] + t in i); )
            ;
        return n < 0 ? null : (3 === n ? "ms" : n >= 0 ? Gr[n] : "") + t
    }, Qr = function() {
        "undefined" != typeof window && window.document && (_r = window,
        dr = _r.document,
        mr = dr.documentElement,
        vr = jr("div") || {
            style: {}
        },
        yr = jr("div"),
        ...
        var r, i = jr("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), n = this.parentNode, s = this.nextSibling, a = this.style.cssText;
        if (mr.appendChild(i),
        i.appendChild(this),
        ...
        if (e) {
            ...
            r.removeProperty(e.replace(kr, "-$1").toLowerCase())) : r.removeAttribute(e)
        }
    }, ti = function(t, e, r, i, n, s) {
        var a = new hr(t._pt,e,r,0,1,s ? Er : Rr);
        return t._pt = a,
        a.b = i,
        a.e = n,
        t._props.push(r),
        ...
        var s, a, o, u, h = parseFloat(i) || 0, l = (i + "").trim().substr((h + "").length) || "px", f = vr.style, c = Cr.test(r), p = "svg" === e.tagName.toLowerCase(), _ = (p ? "client" : "offset") + (c ? "Width" : "Height"), d = "px" === n, m = "%" === n;
        return n === l || !h || ei[n] || ei[l] ? h : ("px" !== l && !d && (h = t(e, r, i, "px")),
        u = e.getCTM && Jr(e),
        m && (Tr[r] || ~r.indexOf("adius")) ? Tt(h / (u ? e.getBBox()[c ? "width" : "height"] : e[_]) * 100) : (f[c ? "width" : "height"] = 100 + (d ? l : n),
        a = ~r.indexOf("adius") || "em" === n && e.appendChild && !p ? e : e.parentNode,
        u && (a = (e.ownerSVGElement || {}).parentNode),
        a && a !== dr && a.appendChild || (a = dr.body),
        (o = a._gsap) && m && o.width && c && o.time === Me.time ? Tt(h / o.width * 100) : ((m || "%" === l) && (f.position = Vr(e, "position")),
        a === e && (f.position = "static"),
        a.appendChild(vr),
        s = vr[_],
        a.removeChild(vr),
        f.position = "absolute",
        c && m && ((o = yt(a)).time = Me.time,
        o.width = a[_]),
        Tt(d ? s * h / 100 : s && h ? 100 / s * h : 0))))
    }, ii = function(t, e, r, i) {
        var n;
        return gr || Qr(),
        e in Dr && "transform" !== e && ~(e = Dr[e]).indexOf(",") && (e = e.split(",")[0]),
        Tr[e] && "transform" !== e ? (n = _i(t, i),
        n = "transformOrigin" !== e ? n[e] : di(Vr(t, qr)) + " " + n.zOrigin + "px") : (!(n = t.style[e]) || "auto" === n || i || ~(n + "").indexOf("calc(")) && (n = oi[e] && oi[e](t, e, r) || Vr(t, e) || xt(t, e) || ("opacity" === e ? 1 : 0)),
        r && !~(n + "").indexOf(" ") ? ri(t, e, n, r) + r : n
    }, ni = function(t, e, r, i) {
        if (!r || "none" === r) {
            var n = Wr(e, t, 1)
              , s = n && Vr(t, n, 1);
            s && s !== r ? (e = n,
            r = s) : "borderColor" === e && (r = Vr(t, "borderTopColor"))
        }
        var a, o, u, h, l, f, c, p, _, d, m, g, v = new hr(this._pt,t.style,e,0,1,ir), y = 0, x = 0;
        if (v.b = r,
        v.e = i,
        r += "",
        "auto" === (i += "") && (t.style[e] = i,
        ...
        (i.match(K) || []).length) {
            for (; o = K.exec(i); )
                ...
                c !== (f = u[x++] || "") && (h = parseFloat(f) || 0,
                m = f.substr((h + "").length),
                (g = "=" === c.charAt(1) ? +(c.charAt(0) + "1") : 0) && (c = c.substr(2)),
                p = parseFloat(c),
                d = c.substr((p + "").length),
                y = K.lastIndex - d.length,
                d || (d = d || z.units[e] || m,
                y === i.length && (i += d,
                v.e += d)),
                m !== d && (h = ri(t, e, f, d) || 0),
        ...
        clearProps: function(t, e, r, i, n) {
            if ("isFromStart" !== n.data) {
                var s = t._pt = new hr(t._pt,e,r,0,0,ai);
                return s.u = i,
                s.pr = -10,
                s.tween = n,
                t._props.push(r),
    ...
    }, ui = [1, 0, 0, 1, 0, 0], hi = {}, li = function(t) {
        return "matrix(1, 0, 0, 1, 0, 0)" === t || "none" === t || !t
    }, fi = function(t) {
        var e = Vr(t, Ur);
        return li(e) ? ui : e.substr(7).match(J).map(Tt)
    }, ci = function(t, e) {
        var r, i, n, s, a = t._gsap || yt(t), o = t.style, u = fi(t);
        return a.svg && t.getAttribute("transform") ? "1,0,0,1,0,0" === (u = [(n = t.transform.baseVal.consolidate().matrix).a, n.b, n.c, n.d, n.e, n.f]).join(",") ? ui : u : (u !== ui || t.offsetParent || t === mr || a.svg || (n = o.display,
        o.display = "block",
        ...
        s && (i ? r.insertBefore(t, i) : r ? r.appendChild(t) : mr.removeChild(t))),
        e && u.length > 6 ? [u[0], u[1], u[4], u[5], u[12], u[13]] : u)
    }, pi = function(t, e, r, i, n, s) {
        var a, o, u, h = t._gsap, l = n || ci(t, !0), f = h.xOrigin || 0, c = h.yOrigin || 0, p = h.xOffset || 0, _ = h.yOffset || 0, d = l[0], m = l[1], g = l[2], v = l[3], y = l[4], x = l[5], b = e.split(" "), T = parseFloat(b[0]) || 0, w = parseFloat(b[1]) || 0;
        r ? l !== ui && (o = d * v - m * g) && (u = T * (-m / o) + w * (d / o) - (d * x - m * y) / o,
        T = T * (v / o) + w * (-g / o) + (g * x - v * y) / o,
        w = u) : (T = (a = $r(t)).x + (~b[0].indexOf("%") ? T / 100 * a.width : T),
        ...
        t.style[qr] = "0px 0px",
        s && (ti(s, h, "xOrigin", f, T),
        ti(s, h, "yOrigin", c, w),
        ti(s, h, "xOffset", p, h.xOffset),
        ti(s, h, "yOffset", _, h.yOffset)),
        t.setAttribute("data-svg-origin", T + " " + w)
    }, _i = function(t, e) {
        var r = t._gsap || new Ie(t);
        if ("x"in r && !e && !r.uncache)
            return r;
        var i, n, s, a, o, u, h, l, f, c, p, _, d, m, g, v, y, x, b, T, w, O, M, k, C, A, D, S, P, F, R, E, B = t.style, L = r.scaleX < 0, I = Vr(t, qr) || "0";
        return i = n = s = u = h = l = f = c = p = 0,
        a = o = 1,
        r.svg = !(!t.getCTM || !Jr(t)),
        m = ci(t, r.svg),
        r.svg && (k = !r.uncache && t.getAttribute("data-svg-origin"),
        pi(t, k || I, !!k || r.originIsAbsolute, !1 !== r.smooth, m)),
        _ = r.xOrigin || 0,
        d = r.yOrigin || 0,
        m !== ui && (x = m[0],
        b = m[1],
        ...
        i = O = m[4],
        n = M = m[5],
        6 === m.length ? (a = Math.sqrt(x * x + b * b),
        o = Math.sqrt(w * w + T * T),
        u = x || b ? Mr(b, x) * wr : 0,
        (f = T || w ? Mr(T, w) * wr + u : 0) && (o *= Math.cos(f * Or)),
        r.svg && (i -= _ - (_ * x + d * T),
        n -= d - (_ * b + d * w))) : (E = m[6],
        F = m[7],
        D = m[8],
        ...
        s = m[14],
        h = (g = Mr(E, P)) * wr,
        g && (k = O * (v = Math.cos(-g)) + D * (y = Math.sin(-g)),
        C = M * v + S * y,
        A = E * v + P * y,
        D = O * -y + D * v,
        S = M * -y + S * v,
        ...
        l = (g = Mr(-T, P)) * wr,
        g && (v = Math.cos(-g),
        R = w * (y = Math.sin(-g)) + R * v,
        x = k = x * v - D * y,
        b = C = b * v - S * y,
        T = A = T * v - P * y),
        u = (g = Mr(b, x)) * wr,
        g && (k = x * (v = Math.cos(g)) + b * (y = Math.sin(g)),
        C = O * v + M * y,
        b = b * v - x * y,
        M = M * v - O * y,
        x = k,
        ...
        l = 180 - l),
        a = Tt(Math.sqrt(x * x + b * b + T * T)),
        o = Tt(Math.sqrt(M * M + E * E)),
        g = Mr(O, M),
        f = Math.abs(g) > 2e-4 ? g * wr : 0,
        p = R ? 1 / (R < 0 ? -R : R) : 0),
        r.svg && (k = t.getAttribute("transform"),
        r.forceCSS = t.setAttribute("transform", "") || !li(Vr(t, Ur)),
        ...
        (r.zOrigin = parseFloat(I.split(" ")[2]) || 0) && (B[qr] = di(I)),
        r.xOffset = r.yOffset = 0,
        r.force3D = z.force3D,
        r.renderTransform = r.svg ? yi : br ? vi : gi,
        r.uncache = 0,
        r
    }, di = function(t) {
        ...
        var r = e || this
          ...
          , x = "auto" === m && t && 1 !== t || !0 === m;
        if (v && ("0deg" !== l || "0deg" !== h)) {
            var b, T = parseFloat(h) * Or, w = Math.sin(T), O = Math.cos(T);
            T = parseFloat(l) * Or,
            b = Math.cos(T),
            s = mi(g, s, w * b * -v),
            a = mi(g, a, -Math.sin(T) * -v),
            o = mi(g, o, O * b * -v + v)
        }
        ...
        var r, i, n, s, a, o = e || this, u = o.xPercent, h = o.yPercent, l = o.x, f = o.y, c = o.rotation, p = o.skewX, _ = o.skewY, d = o.scaleX, m = o.scaleY, g = o.target, v = o.xOrigin, y = o.yOrigin, x = o.xOffset, b = o.yOffset, T = o.forceCSS, w = parseFloat(l), O = parseFloat(f);
        c = parseFloat(c),
        p = parseFloat(p),
        ...
        s = m,
        i = n = 0),
        (w && !~(l + "").indexOf("px") || O && !~(f + "").indexOf("px")) && (w = ri(g, "x", l, "px"),
        O = ri(g, "y", f, "px")),
        (v || y || x || b) && (w = Tt(w + v - (v * r + y * n) + x),
        O = Tt(O + y - (v * i + y * s) + b)),
        (u || h) && (a = g.getBBox(),
        w = Tt(w + u / 100 * a.width),
        O = Tt(O + h / 100 * a.height)),
        a = "matrix(" + r + "," + i + "," + n + "," + s + "," + w + "," + O + ")",
        g.setAttribute("transform", a),
        T && (g.style[Ur] = a)
    }, xi = function(t, e, r, i, n, s) {
        var a, o, u = X(n), h = parseFloat(n) * (u && ~n.indexOf("rad") ? wr : 1), l = s ? h * s : h - i, f = i + l + "deg";
        return u && ("short" === (a = n.split("_")[1]) && (l %= 360) !== l % 180 && (l += l < 0 ? 360 : -360),
        "cw" === a && l < 0 ? l = (l + 36e9) % 360 - 360 * ~~(l / 360) : "ccw" === a && l > 0 && (l = (l - 36e9) % 360 - 360 * ~~(l / 360))),
        t._pt = o = new hr(t._pt,e,r,i,l,Pr),
        o.e = f,
        o.u = "deg",
        t._props.push(r),
        o
    }, bi = function(t, e, r) {
        var i, n, s, a, o, u, h, l = yr.style, f = r._gsap;
        for (n in l.cssText = getComputedStyle(r).cssText + ";position:absolute;display:block;",
        l[Ur] = e,
        dr.body.appendChild(yr),
        i = _i(yr, 1),
        Tr)
            (s = f[n]) !== (a = i[n]) && "perspective,force3D,transformOrigin,svgOrigin".indexOf(n) < 0 && (o = te(s) !== (h = te(a)) ? ri(r, n, s, h) : parseFloat(s),
            u = parseFloat(a),
            t._pt = new hr(t._pt,f,n,o,u - o,Sr),
            t._pt.u = h || 0,
            t._props.push(n));
        dr.body.removeChild(yr)
    };
    ...
    var Ti, wi, Oi = {
        ...
        init: function(t, e, r, i, n) {
            var s, a, o, u, h, l, f, c, p, _, d, m, g, v, y, x, b, T, w, O = this._props, M = t.style;
            for (f in gr || Qr(),
            e)
                ...
                !pt[f] || !je(f, e, r, i, t, n)))
                    ...
                    l)
                        ...
                        this.add(M, "setProperty", getComputedStyle(t).getPropertyValue(f) + "", a + "", i, n, 0, 0, f);
                    else if ("undefined" !== h) {
                        if (s = ii(t, f),
                        u = parseFloat(s),
                        (_ = "string" === h && "=" === a.charAt(1) ? +(a.charAt(0) + "1") : 0) && (a = a.substr(2)),
                        o = parseFloat(a),
                        f in Dr && ("autoAlpha" === f && (1 === u && "hidden" === ii(t, "visibility") && o && (u = 0),
                        ti(this, M, "visibility", u ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)),
                        "scale" !== f && "transform" !== f && ~(f = Dr[f]).indexOf(",") && (f = f.split(",")[0])),
                        d = f in Tr)
                            if (m || ((g = t._gsap).renderTransform || _i(t),
                            v = !1 !== e.smoothOrigin && g.smooth,
                            (m = this._pt = new hr(this._pt,M,Ur,0,1,g.renderTransform,g,0,-1)).dep = 1),
                            "scale" === f)
                                this._pt = new hr(this._pt,g,"scaleY",g.scaleY,_ ? _ * o : o - g.scaleY),
                                O.push("scaleY", f),
                                f += "X";
                            else {
                                if ("transformOrigin" === f) {
                                    ...
                                    T = b[0],
                                    w = b[1] || "50%",
                                    "top" !== T && "bottom" !== T && "left" !== w && "right" !== w || (x = T,
                                    T = w,
                                    w = x),
                                    b[0] = si[T] || T,
                                    b[1] = si[w] || w,
                                    a = b.join(" "),
                                    g.svg ? pi(t, a, 0, v, 0, this) : ((p = parseFloat(a.split(" ")[2]) || 0) !== g.zOrigin && ti(this, g, "zOrigin", g.zOrigin, p),
                                    ti(this, M, f, di(s), di(a)));
                                    continue
                                }
                                if ("svgOrigin" === f) {
                                    pi(t, a, 1, v, 0, this);
                            ...
                            f in M || (f = Wr(f) || f);
                        if (d || (o || 0 === o) && (u || 0 === u) && !Ar.test(a) && f in M)
                            o || (o = 0),
                            (c = (s + "").substr((u + "").length)) !== (p = te(a) || (f in z.units ? z.units[f] : c)) && (u = ri(t, f, s, p)),
                            this._pt = new hr(this._pt,d ? g : M,f,u,_ ? _ * o : o - u,"px" !== p || !1 === e.autoRound || d ? Sr : Fr),
                            this._pt.u = p || 0,
                            c !== p && (this._pt.b = s,
                            this._pt.r = zr);
                        else if (f in M)
                            ni.call(this, t, f, s, a);
                        else {
                            if (!(f in t)) {
                                at(f, a);
                                continue
        ...
        getSetter: function(t, e, r) {
            ...
            e in Tr && e !== qr && (t._gsap.x || ii(t, "x")) ? r && xr === r ? "scale" === e ? Yr : Ir : (xr = r || {}) && ("scale" === e ? Nr : Xr) : t.style && !j(t.style[e]) ? Br : ~e.indexOf("-") ? Lr : tr(t, e)
        },
        core: {
            _removeProperty: Kr,
            _getMatrix: ci
    ...
    pr.utils.checkPrefix = Wr,
    wi = bt("x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + (Ti = "rotation,rotationX,rotationY,skewX,skewY") + ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", (function(t) {
        Tr[t] = 1
    }
    )),
    bt(Ti, (function(t) {
    ...
    Dr[wi[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + Ti,
    ...
    pr.registerPlugin(Oi);
    var Mi, ki, Ci, Ai, Di, Si, Pi, zi, Fi = pr.registerPlugin(Oi) || pr;
    Fi.core.Tween;
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        function e() {
            Di = (Ai - ki) / ki,
            Si = (Ci - Mi) / Mi,
            Pi = Math.sqrt(Math.pow(Di, 2) + Math.pow(Si, 2)),
            zi = 12 * Pi,
            Fi.to(".content", 1, {
                transform: "rotate3d( ".concat(Di, ", ").concat(Si, ", 0, ").concat(zi, "deg )")
            })
        }
        Mi = window.innerWidth / 2,
        ki = window.innerHeight / 2,
