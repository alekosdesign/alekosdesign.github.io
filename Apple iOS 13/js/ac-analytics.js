require = function() {
    ...
    75: [function(require, module, exports) {
        ...
        var utils = require("@apple/analytics-utils"),
            ...
            cookieOpts = {
                path: "/",
                domain: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/apple.com",
                secure: !0
            };
    ...
    90: [function(require, module, exports) {
        ...
        function channel(e, r) {
            var n = "www.",
                o = {
                    "fr-ca": "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/ca.fr"
                };
    ...
    134: [function(require, module, exports) {
        "use strict";
        var production = ["https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/www.apple.com", "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/images.apple.com", "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/movies.apple.com", "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/ssl.apple.com", "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/search.apple.com", "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/partner-relay.apple.com"];

        function getTrackingServer() {
            return _isProduction() ? "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/metrics.apple.com" : location.hostname
        }

        function getSecureTrackingServer() {
            return _isProduction() ? "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/securemetrics.apple.com" : location.hostname
        }
    ...
    146: [function(require, module, exports) {
        ...
        function specialExitLinks() {
            ...
            return [{
                name: "deploy",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/deploy.apple.com"
            }, {
                name: "ade",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/ade.apple.com"
            }, {
                name: "appleteacher",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/appleteacher.apple.com"
            }, {
                name: "ecommerce",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/ecommerce.apple.com"
            }, {
                name: "school",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/school.apple.com"
            }, {
                name: "help",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/help.apple.com"
            }, {
                name: "survey",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/survey.apple.com"
            }, {
                name: "itunespartner",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/itunespartner.apple.com"
            }, {
                name: "investor",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/investor.apple.com"
            }, {
                name: "consultants",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/consultants.apple.com"
            }, {
                name: "itms",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/itms.apple.com"
            }, {
                name: "artists",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/artists.apple.com"
            }, {
                name: "itunes",
                url: "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/itunes.apple.com"
            ...
            window.AppMeasurement_Module_ActivityMap = function(e) {
                ...
                r._g = function() {
                    var t, a, n, r = e.contextData,
                        o = e.linkObject;
                    (t = e.pageName || e.pageURL) && (a = i(o, "link", e.linkName)) && (n = i(o, "region")) && (r["https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/a.activitymap.page"] = t.substring(0, 255), r["https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/a.activitymap.link"] = 128 < a.length ? a.substring(0, 128) : a, r["a.activitymap.region"] = 127 < n.length ? n.substring(0, 127) : n, r["a.activitymap.pageIDType"] = e.pageName ? 1 : 0)
                }, r.link = function(e, i) {
                    var o;
                ...
                t.F = function(e) {
                    ...
                    var t, a, i, n, r, o, c = 0,
                        s = "",
                        l = "";
                    if (e && 255 < e.length && (0 < (a = (t = "" + e).indexOf("?")) && (o = t.substring(a + 1), i = 0, "http://" == (n = (t = t.substring(0, a)).toLowerCase()).substring(0, 7) ? i += 7 : "https://" == n.substring(0, 8) && (i += 8), 0 < (a = n.indexOf("/", i)) && (n = n.substring(i, a), r = t.substring(a), t = t.substring(0, a), 0 <= n.indexOf("google") ? c = ",q,ie,start,search_key,word,kw,cd," : 0 <= n.indexOf("https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/yahoo.co") && (c = ",p,ei,"), c && o)))) {
                    ...
                    n ? t.trackingServerSecure && t.ssl && (n = t.trackingServerSecure) : (c || (0 <= (n = (c = t.account).indexOf(",")) && (c = c.substring(0, n)), c = c.replace(/[^A-Za-z0-9]/g, "")), i || (i = "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/2o7.net"), r = r ? ("" + r).toLowerCase() : "d1", "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/2o7.net" == i && ("d1" == r ? r = "112" : "d2" == r && (r = "122"), o = ""), n = c + "." + r + "." + o + i), i = t.ssl ? "https://" : "http://", r = t.AudienceManagement && t.AudienceManagement.isReady() || 0 != t.usePostbacks, i += n + "/b/ss/" + t.account + "/" + (t.mobile ? "5." : "") + (r ? "10" : "1") + "/JS-" + t.version + (t.Mb ? "T" : "") + (t.tagContainerMarker ? "-" + t.tagContainerMarker : "") + "/" + e + "?AQB=1&ndh=1&pf=1&" + (r ? "callback=s_c_il[" + t._in + "].doPostbacks&et=1&" : "") + a + "&AQE=1", t.cb(i), t.vb(i), t.ka()
    ...
    180: [function(require, module, exports) {
        ...
        proto.prefixCharacters = function(t, e, r) {
            ...
            var e;
            return t.hostname !== window.location.hostname && "https://www.apple.com/metrics/ac-analytics/2.7.1/scripts/www.apple.com" !== t.hostname && (e = t.hostname + t.pathname), e || t.hash || t.pathname || "no href"
