...
var Character = function Character(_ref) {
  var animation = _ref.animation,
      armPath = _ref.armPath;

  var characterClass = "character -" + animation;
  return React.createElement(
    "svg",
    { className: characterClass, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 300 400" },
...
// Left arm component
var ArmLeft = function ArmLeft(_ref2) {
  var animation = _ref2.animation,
      armPath = _ref2.armPath;
  return React.createElement(
    "svg",
    { className: "arm", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 300 400" },
...
// Right arm component
var ArmRight = function ArmRight(_ref3) {
  var animation = _ref3.animation,
      armPath = _ref3.armPath;
  return React.createElement(
    "svg",
    { className: "arm", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 300 400" },
...
// Computer component
var Computer = function Computer(_ref4) {
  var animation = _ref4.animation;

  var computerClass = "computer -" + animation;
  return React.createElement(
    "svg",
    { className: computerClass, xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 82 55" },
...
var Table = function Table() {
  return React.createElement(
    "svg",
    { className: "table", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 530 160.1" },
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    key: "createCurve",
    value: function createCurve(x, offset) {
      ...
      var phase = inverted ? Math.sqrt(x * frequency) - offset : Math.sqrt(x * frequency) + offset;
    ...
    value: function updateArms() {
      var _state2 = this.state,
          ystart = _state2.ystart,
          xstart = _state2.xstart,
    ...
    key: "setAnimation",
    value: function setAnimation(newAnimation, speed) {
      this.setState({
    ...
    value: function render() {
      ...
      var _state4 = this.state,
          frequency = _state4.frequency,
          amplitude = _state4.amplitude,
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            { onClick: function onClick() {
                return _this3.setAnimation('passive');
              } },
            "Passive"
          ),
          React.createElement(
            "button",
            { onClick: function onClick() {
                return _this3.setAnimation('waiting');
              } },
            "Waiting"
          ),
          React.createElement(
            "button",
            { onClick: function onClick() {
                return _this3.setAnimation('thinking');
              } },
            "Thinking"
          ),
          React.createElement(
            "button",
            { onClick: function onClick() {
                return _this3.setAnimation('typing');
              } },
            "Typing"
          ),
          React.createElement(
            "button",
            { onClick: function onClick() {
                return _this3.setAnimation('stressed', 240);
              } },
            "Nailing it"
          )
        ),
        animation === 'stressed' && React.createElement(
          "div",
          { className: "sliders" },
